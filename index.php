...
<body class="animsition">
    <div class="page-wrapper">
        ...
        <div class="page-container2">
            ...
            else if(@$_GET['page'] == "penjualan"){  // file penjualan ada di dalam folder view dan masuk ke folder transaksi  
                include "view/transaksi/penjualan.php";
            }
            else if(@$_GET['page'] == "user"){
                include "view/pengaturan/user.php";
            }
            else if(@$_GET['page'] == "ubah-password"){
                include "view/pengaturan/ubah-password.php";
            }
            else{
                include "content-dashboard.php";
            }
...
<!--
    keterangan :
    if(@$_GET)['page'] == "soal-uts.php"{
    jika sebuah variabel atau parameter GET dengan nama page
    bernilai member, maka akan menjalankan perintah

    include "view/soal-uts.php";
    menyisipkan file member.php yang berada di folder view/master
